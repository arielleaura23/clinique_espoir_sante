...
<html lang="en">
    ...
    <body>
        <form class="registration-form" action="{{ route('password.store') }}" method="POST">
            @csrf
            ...
            <div class="background-rectangle">
                <header class="header-section">
                    <h1 class="welcome-title">
                        ...
                        <span class="clinic-register-text">RESET PASSWORD</span>
                    </h1>
                ...
                <button style="cursor: pointer" class="submit-button" type="submit">
                    ...
                    <span class="button-text">Reinitialiser</span>
                </button>
