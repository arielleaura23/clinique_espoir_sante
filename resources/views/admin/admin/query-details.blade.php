                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('admin.queries.update', $query->id) }}">
                                            ...
                                            <button type="submit" class="btn btn-primary pull-left" style="margin-top:10px;">
                            ...
                            @else
                                ...
                                <tr>
                                    ...
                                    <td>{{ $query->LastupdationDate ? \Carbon\Carbon::parse($query->LastupdationDate)->format('d/m/Y H:i') : '' }}</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
