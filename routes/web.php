...
Route::prefix('doctor')->group(function () {
    ...
    // Doctors
    Route::get('/doctor-specialization', [DoctorController::class, 'doctorSpecialization'])->name('admin.doctor.specialization');
    Route::get('/add-doctor', [DoctorController::class, 'addDoctorForm'])->name('admin.doctor.add');
    Route::post('/add-doctor', [DoctorController::class, 'addDoctor'])->name('admin.doctor.add.store');
    Route::get('/manage-doctors', [DoctorController::class, 'manageDoctors'])->name('admin.doctor.manage');
    Route::post('/doctor-specialization', [DoctorController::class, 'store'])->name('admin.doctor.specialization.store');
    Route::get('/doctor-specialization/{id}/edit', [DoctorController::class, 'editDoctorSpecialization'])->name('admin.doctor.specialization.edit');
    Route::put('/admin/doctor-specialization/{id}', [DoctorController::class, 'updateDoctorSpecialization'])->name('admin.doctor.specialization.update');
    Route::delete('/doctor-specialization/{id}', [DoctorController::class, 'destroy'])->name('admin.doctor.specialization.delete');
    Route::delete('/admin/manage-doctors/{id}', [DoctorController::class, 'deleteDoctor'])->name('admin.doctor.delete');
    Route::get('/admin/edit-doctor/{id}', [DoctorController::class, 'editDoctor'])->name('admin.doctor.edit'); // à créer si besoin


    // Users
    Route::get('/manage-users', [DoctorController::class, 'manageUsers'])->name('admin.users.manage');

    // Patients
    Route::get('/manage-patient', [DoctorController::class, 'managePatients'])->name('admin.patients.manage');
    Route::get('/view-patient/{id}', [DoctorController::class, 'viewPatient'])->name('admin.patient.view');
    Route::post('/view-patient/{id}/add-medicalhistory', [DoctorController::class, 'addMedicalHistory'])->name('admin.patient.medicalhistory.add');

    // Appointment History
    Route::get('/appointment-history', [DoctorController::class, 'appointmentHistory'])->name('admin.appointment.history');

    // Contactus Queries
    Route::get('/unread-queries', [DoctorController::class, 'unreadQueries'])->name('admin.queries.unread');
    Route::get('/query-details/{id}', [DoctorController::class, 'queryDetails'])->name('admin.queries.details');
    Route::put('/query-details/{id}', [DoctorController::class, 'updateQuery'])->name('admin.queries.update');
    Route::get('/read-queries', [DoctorController::class, 'readQueries'])->name('admin.queries.read');

    // Logs
    Route::get('/doctor-logs', [DoctorController::class, 'doctorLogs'])->name('admin.doctor.logs');
    Route::get('/user-logs', [DoctorController::class, 'userLogs'])->name('admin.user.logs');

    // Reports
    Route::get('/between-dates-reports', [DoctorController::class, 'betweenDatesReports'])->name('admin.reports.between_dates');

    // Pages
    Route::get('/about-us', [DoctorController::class, 'aboutUs'])->name('admin.pages.about');
    Route::get('/contact', [DoctorController::class, 'contactUs'])->name('admin.pages.contact');

    // Patient Search
    Route::get('/patient-search', [DoctorController::class, 'patientSearch'])->name('admin.patient.search');
});
